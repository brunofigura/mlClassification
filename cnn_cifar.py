...
class Classifier:
    ...
    def plot_val_train_losses(self):
        ...
        plot_filename = f'TrainValLoss_cnn_cifar_{self.n_epochs}-Epochs.png'
    ...
    def saveModelWeights(self, epoch):
        modelSavePath = f'./trainedModels/cnn_cifar_epoch_{epoch}.ckpt'
    ...
    def display_and_save_predictions(self, n_images=25, directory='./predictions'):
        ...
        os.makedirs(directory, exist_ok=True)
        raster_path = os.path.join(directory, f'CNN_CIFAR_{self.n_epochs}_epochs_predictions_grid.png')
