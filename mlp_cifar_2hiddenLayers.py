...
class Classifier:
    ...
    def plot_val_train_losses(self):
        ...
        plot_filename = f'TrainValLoss_mlp2_cifar_{self.n_epochs}-Epochs.png'
    ...
    def plot_confMatrix(self):
        ...
        plt.xticks(rotation=45)  # Drehet die Achsenbeschriftungen für bessere Lesbarkeit
        plt.yticks(rotation=45)
        plt.savefig(f'./confusion_Matrices/cm_CIFAR_MLP_2_hiddenL_{self.n_epochs}-Epochs.png')  # Speichert die Confusion Matrix als PNG-Datei
        plt.show()
    ...
    def display_and_save_predictions(self, n_images=25, directory='./predictions'):
            ...
            os.makedirs(directory, exist_ok=True)
            raster_path = os.path.join(directory, f'MLP2_CIFAR_{self.n_epochs}_epochs_predictions_grid.png')
